...
export default function Main() {
  return (
    <main className='main'>
      ...
      <section className='main__sectionA'>
        <h1 className='main__sectionA__title'>
          Evaluaciones para ingreso escolar
        </h1>
        <p className='main__sectionA__subtitle'>
          <span>.Lic. en fonoaudiología</span>
          <span>.Mp: 0256</span>
        </p>
      </section>
      <a href='https://wa.me/5492804005121' target="_blank" rel="noreferrer">
        <section className='main__contact'>
          <span>Maira Konz</span>
          <span>
